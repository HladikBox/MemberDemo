...
public list(search_condition_json, showLoadingModal:boolean=true) {
        var url = ApiConfig.getApiUrl()+"memberrank/list";
        ...
        return this.http.post(url, body, options).toPromise()
            .then((res) => {
                if(ApiConfig.DataLoadedHandle("memberrank/list",search_condition_json,res)){
                  if(showLoadingModal){
            ...
            .catch(err => {
                ...
                return ApiConfig.ErrorHandle("memberrank/list",search_condition_json,err);
            });
