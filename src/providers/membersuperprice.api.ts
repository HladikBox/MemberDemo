...
*/
@Injectable()
export class MembersuperpriceApi {
...
public list(search_condition_json, showLoadingModal:boolean=true) {
        var url = ApiConfig.getApiUrl()+"membersuperprice/list";
        ...
        return this.http.post(url, body, options).toPromise()
            .then((res) => {
                if(ApiConfig.DataLoadedHandle("membersuperprice/list",search_condition_json,res)){
                  if(showLoadingModal){
            ...
            .catch(err => {
                ...
                return ApiConfig.ErrorHandle("membersuperprice/list",search_condition_json,err);
            });
