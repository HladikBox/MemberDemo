...
export class ApiConfig {
    ...
    public static getApiUrl() {
        return "http://cmsdev.app-link.org/alucard263096/membercomponent/api/";
    }
    public static getUploadPath() {
        return "http://cmsdev.app-link.org/alucard263096/membercomponent/upload/";
    }
    public static getFileUploadAPI() {
        return "http://cmsdev.app-link.org/alucard263096/membercomponent/fileupload";
    }
    public static getDataBaseName() {
        return "alucard263096_membercomponent.db";
    }
